...
function SnackAddModal({ isAddModalVisibleState, snackAddModalHandler, onImageSelected, setUploadedFiles }) {
	...
	const handleComplete = (data) => {
		console.log(data); // '서울 성동구 왕십리로2길 20 (성수동1가)'
	};
				...
				<StBackGround>
					<StModalBox>
						<div onClick={(e) => e.stopPropagation()}>
							<SnackDropZone onImageSelected={setUploadedFiles} setSelectedImage={setSelectedImage} />
						</div>
